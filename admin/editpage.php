...
<div>
<p>
<input type="checkbox" name="listings_featured" id="listings_featured"
...
<p>
<select name="listings_status" class="status-input required" 
id="listings_status">
...
<p>
<input type="text" name="listings_listprice" class="price-input number" 
...
<input type="text" name="listings_listdate" class="date-input date" 
...
<p>
<input type="text" name="listings_saleprice" class="price-input number" 
...
<input type="text" name="listings_saledate" class="date-input date" 
...
<p><input type="text" name="listings_blurb" class="blurb-input" 
...
<p>
<input type="text" name="listings_address" 
...
<p>
<input type="text" name="listings_city" 
...
<p>
<input type="text" name="listings_state" 
...
<p>
<input type="text" name="listings_postcode" 
...
<p><input type="text" name="listings_mlsid" 
...
<p>
<input type="text" class="number" name="listings_bedrooms" 
...
<input 
type="text" class="number" name="listings_bathrooms" 
...
<input type="text" class="number" name="listings_halfbaths" 
...
<input type="text" class="number" name="listings_garage" 
...
<p>
<select id="listings_galleryid" name="listings_galleryid" class="gallery-input" >
...
<p>
<select id="listings_videoid" name="listings_videoid" class="video-input" >
...
<p>
<select id="listings_downloadid" name="listings_downloadid[]" multiple="multiple" style="height: 10em;" size="5">
...
<p>
<select id="listings_panoid" name="listings_panoid[]" 
...
<p>
<input id="listings_latitude" type="text" name="listings_latitude" class="geo-input"
size="15" value="<?php echo $listing->latitude; ?>" />
<label for="listings_latitude"><?php _e('Latitude (eg: 26.123456)','greatrealestate'); ?></label>
</p>

<p>
<input id="listings_longitude" type="text" name="listings_longitude" class="geo-input" 
